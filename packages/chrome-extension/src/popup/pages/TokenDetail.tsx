...
import { ArrowLeft, Shield, ShieldAlert, Star, Users, BarChart3, Copy, Check, Send, ArrowLeftRight, Loader2, Globe, ExternalLink } from "lucide-react";
  ...
  if (error || !token) {
    return (
      <div className="p-3 space-y-3">
        ...
        <p className="text-sm text-red-400">Token not found</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-3 space-y-3 overflow-y-auto h-full">
      ...
      <div className="flex gap-2">
        ...
        >
          <ArrowLeftRight size={12} /> {t("nav.swap", "Swap")}
        </button>
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-2.5">
          <div className="flex items-center gap-1 mb-1">
            ...
            <span className="text-[9px] text-stellar-muted uppercase">Rating</span>
          </div>
        ...
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-2.5">
          <div className="flex items-center gap-1 mb-1">
            ...
            <span className="text-[9px] text-stellar-muted uppercase">Holders</span>
          </div>
          <p className="text-sm font-bold text-white">
        ...
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-2.5">
          <div className="flex items-center gap-1 mb-1">
            ...
            <span className="text-[9px] text-stellar-muted uppercase">Trades</span>
          </div>
          <p className="text-sm font-bold text-white">
        ...
        <div className="bg-stellar-card border border-stellar-border rounded-lg p-2.5">
          <div className="flex items-center gap-1 mb-1">
            ...
            <span className="text-[9px] text-stellar-muted uppercase">Payments</span>
          </div>
          <p className="text-sm font-bold text-white">
